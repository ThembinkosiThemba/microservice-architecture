...
import (
	...
	"monolith-microservice/pkg/common/cmd"
	orders_app "monolith-microservice/pkg/orders/application"
	orders_infra_orders "monolith-microservice/pkg/orders/infrastructure/orders"
	orders_infra_payments "monolith-microservice/pkg/orders/infrastructure/payments"
	orders_infra_product "monolith-microservice/pkg/orders/infrastructure/shop"
	orders_interfaces_intraprocess "monolith-microservice/pkg/orders/interfaces/private/intraprocess"
	orders_interfaces_http "monolith-microservice/pkg/orders/interfaces/public/http"
	payments_app "monolith-microservice/pkg/payments/application"
	payments_infra_orders "monolith-microservice/pkg/payments/infrastructure/orders"
	payments_interfaces_intraprocess "monolith-microservice/pkg/payments/interfaces/intraprocess"
	"monolith-microservice/pkg/shop"
	shop_app "monolith-microservice/pkg/shop/application"
	shop_infra_product "monolith-microservice/pkg/shop/infrastructure/products"
	shop_interfaces_intraprocess "monolith-microservice/pkg/shop/interfaces/private/intraprocess"
	shop_interfaces_http "monolith-microservice/pkg/shop/interfaces/public/http"
